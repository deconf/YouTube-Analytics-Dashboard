...
<div id="poststuff">
    <div id="post-body" class="metabox-holder columns-2">
		...
		<p>
                            <input name="yt_dash_userapi" type="checkbox" id="yt_dash_userapi" onchange="this.form.submit()" value="1" <?php if (get_option('yt_dash_userapi')) echo " checked='checked'"; ?> /><?php echo "<b>".__(" use your own API Project credentials", 'yt_dash' )."</b>"; ?></p>
		<?php
		if ( get_option( 'yt_dash_userapi' ) ) {
			?>
			<p><?php echo "<b>".__("API Key:", 'yt_dash')." </b>"; ?><input type="text" name="yt_dash_apikey" value="<?php echo esc_attr($apikey); ?>" size="61">
                        </p>
                        <p><?php echo "<b>".__("Client ID:", 'yt_dash')." </b>"; ?><input type="text" name="yt_dash_clientid" value="<?php echo esc_attr($clientid); ?>" size="60">
                        </p>
                        <p><?php echo "<b>".__("Client Secret:", 'yt_dash')." </b>"; ?><input type="text" name="yt_dash_clientsecret" value="<?php echo esc_attr($clientsecret); ?>" size="55">
                        </p>  
		<?php }?>
		<p><?php
		if ( get_option( 'yt_dash_token' ) ) {
			...
			?> <input type="submit" name="Clear" class="button button-secondary" value="<?php _e('Clear Cache', 'yt_dash' ) ?>" /><?php
		...
		<p>
                            <input name="yt_dash_additional" type="checkbox" id="yt_dash_additional" value="1" <?php if (get_option('yt_dash_additional')) echo " checked='checked'"; ?> /><?php _e(" show additional stats like engagement and annotations performance", 'yt_dash' ); ?></p>
		...
		<select id="yt_dash_cachetime" name="yt_dash_cachetime">
                        ...
                        <p class="submit">
                            <input type="submit" name="Submit" class="button button-primary" value="<?php _e('Save Changes', 'yt_dash' ) ?>" />
                        </p>
                    </form>
                </div>
<?php
        ...
        <div id="postbox-container-1" class="postbox-container">
            <div class="meta-box-sortables">
                <div class="postbox">
                    ...
                    <div class="inside">
                        <a href="https://deconf.com/youtube-analytics-dashboard-wordpress/?utm_source=ytdwp_config&utm_medium=link&utm_content=video&utm_campaign=ytdwp" target="_blank"><img src="<?php echo plugins_url( 'images/youtube-analytics.png' , __FILE__ );?>" width="100%" alt="" /></a>
                    </div>
                </div>
                <div class="postbox">
                    <h3>
                    ...
                    <div class="inside">
                        <div class="deconf-title">
                            <a href="https://deconf.com/youtube-analytics-dashboard-wordpress/?utm_source=ytdwp_config&utm_medium=link&utm_content=support&utm_campaign=ytdwp"><img src="<?php echo plugins_url( 'images/help.png' , __FILE__ ); ?>" /></a>
                        </div>
                        ...
                        <br />
                        <div class="deconf-title">
                            <a href="https://wordpress.org/support/view/plugin-reviews/youtube-analytics#plugin-info"><img src="<?php echo plugins_url( 'images/star.png' , __FILE__ ); ?>" /></a>
                        </div>
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <div class="deconf-title">
                            <a href="https://deconf.com/move-website-https-ssl/?utm_source=ytdwp_config&utm_medium=link&utm_content=ssl&utm_campaign=ytdwp"><img src="<?php echo plugins_url( 'images/ssl.png' , __FILE__ ); ?>" /></a>
                        </div>
                        ...
                        <br />
                        <div class="deconf-title">
                            <a href="https://deconf.com/wordpress/?utm_source=ytdwp_config&utm_medium=link&utm_content=plugins&utm_campaign=ytdwp"><img src="<?php echo plugins_url( 'images/wp.png' , __FILE__ ); ?>" /></a>
                        </div>
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="deconf-desc"><?php echo  __('Speed up your website and plug into a whole', 'yt_dash').' <a href="https://deconf.com/wordpress-cdn-speeds-up-your-site/">'.__('new level of site speed', 'yt_dash').'</a>.'; ?></div>
                        <br />
                        <div class="deconf-title">
                            <a href="https://deconf.com/clicky-web-analytics-review/?utm_source=ytdwp_config&utm_medium=link&utm_content=clicky&utm_campaign=ytdwp"><img src="<?php echo plugins_url( 'images/clicky.png' , __FILE__ ); ?>" /></a>
                        </div>
